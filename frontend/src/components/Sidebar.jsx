...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(fetchConnections, 60000);
  ...
  return (
    <aside className="w-64 shrink-0 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 min-h-[calc(100vh-80px)] p-4">
